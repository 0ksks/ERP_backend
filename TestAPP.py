...
class TestSupplier(unittest.TestCase):
    ...
    def test_create_success(self):
        response = self.app.post(
            ...
            json={"suppliername": "suppliername_value", "communicationLang": "communicationLang_value",
                  "taxNumber": "taxNumber_value", "companyCode": "companyCode_value",
                  "reconciliationAcct": "reconciliationAcct_value", "termsOfPayment": "termsOfPayment_value",
                  "checkDoubleInvoice": "checkDoubleInvoice_value", "clerkName": "clerkName_value",
                  "purchasingOrg": "purchasingOrg_value", "orderCurrency": "orderCurrency_value",
                  "partnerFunctions": "partnerFunctions_value", "streetAddress": "streetAddress_value",
                  "postalCode": "postalCode_value", "city": "city_value", "country": "country_value",
                  "region": "region_value", "contactInfo": "contactInfo_value", "userID": "userID_value"},
    ...
    def test_update_success(self):
        response = self.app.patch(
            ...
            json={"supplierID": "supplierID_value", "suppliername": "suppliername_value",
                  "communicationLang": "communicationLang_value", "taxNumber": "taxNumber_value",
                  "companyCode": "companyCode_value", "reconciliationAcct": "reconciliationAcct_value",
                  "termsOfPayment": "termsOfPayment_value", "checkDoubleInvoice": "checkDoubleInvoice_value",
                  "clerkName": "clerkName_value", "purchasingOrg": "purchasingOrg_value",
                  "orderCurrency": "orderCurrency_value", "partnerFunctions": "partnerFunctions_value",
                  "streetAddress": "streetAddress_value", "postalCode": "postalCode_value", "city": "city_value",
                  "country": "country_value", "region": "region_value", "contactInfo": "contactInfo_value",
                  "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
        )
...
class TestMaterial(unittest.TestCase):
    ...
    def test_create_success(self):
        response = self.app.post(
            ...
            json={"materialName": "materialName_value", "description": "description_value",
                  "baseUnit": "baseUnit_value", "materialGroup": "materialGroup_value", "division": "division_value",
                  "grossWeight": 1.1, "netWeight": 1.1, "weightUnit": "weightUnit_value", "volume": 1.1,
                  ...
                  "plannedDeliveryTime": 1, "valuationClass": "valuationClass_value", "movingPrice": 1.1,
                  "priceUnit": 1, "standardPrice": 1.1, "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
        )
        self.assertEqual(response.status_code, 201)
    ...
    def test_update_success(self):
        response = self.app.patch(
            ...
            json={"materialID": "materialID_value", "materialName": "materialName_value",
                  ...
                  "netWeight": 1.1, "weightUnit": "weightUnit_value", "volume": 1.1, "volumeUnit": "volumeUnit_value",
                  ...
                  "minimumLotSize": 1, "plannedDeliveryTime": 1, "valuationClass": "valuationClass_value",
                  "movingPrice": 1.1, "priceUnit": 1, "standardPrice": 1.1, "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
        )
        self.assertEqual(response.status_code, 200)
...
class TestStock(unittest.TestCase):
    ...
    def test_create_success(self):
        response = self.app.post(
            ...
            json={"materialID": "materialID_value", "plant": "plant_value", "storageLocation": "storageLocation_value",
                  ...
                  "specialStockIndicator": "specialStockIndicator_value", "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
        )
        self.assertEqual(response.status_code, 201)
    ...
    def test_update_success(self):
        response = self.app.patch(
            ...
            json={"stockID": "stockID_value", "materialID": "materialID_value", "plant": "plant_value",
...
class TestGoodsReceipt(unittest.TestCase):
    ...
    def test_create_success(self):
        response = self.app.post(
            ...
            json={"purchaseOrderID": "purchaseOrderID_value", "receiptDate": "2024/01/01",
                  "materialID": "materialID_value", "quantity": 1, "storageLocation": "storageLocation_value",
                  "batch": "batch_value", "plant": "plant_value", "movementType": "movementType_value",
                  "supplierID": "supplierID_value", "documentDate": "2024/01/01", "postingDate": "2024/01/01",
                  "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
        )
    ...
    def test_update_success(self):
        response = self.app.patch(
            ...
            json={"goodsReceiptID": "goodsReceiptID_value", "purchaseOrderID": "purchaseOrderID_value",
                  "receiptDate": "2024/01/01", "materialID": "materialID_value", "quantity": 1,
                  "storageLocation": "storageLocation_value", "batch": "batch_value", "plant": "plant_value",
                  "movementType": "movementType_value", "supplierID": "supplierID_value", "documentDate": "2024/01/01",
                  "postingDate": "2024/01/01", "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
        )
        self.assertEqual(response.status_code, 200)
...
class TestPurchaseOrder(unittest.TestCase):
    ...
    def test_create_success(self):
        response = self.app.post(
            ...
            json={"supplierID": "supplierID_value", "orderDate": "2024/01/01", "deliveryDate": "2024/01/01",
                  "materialID": "materialID_value", "quantity": 1, "netPrice": 1.1, "currency": "currency_value",
                  "purchasingGroup": "purchasingGroup_value", "purchasingOrganization": "purchasingOrganization_value",
                  "plant": "plant_value", "paymentTerms": "paymentTerms_value", "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
        )
        self.assertEqual(response.status_code, 201)
    ...
    def test_update_success(self):
        response = self.app.patch(
            ...
            json={"purchaseOrderID": "purchaseOrderID_value", "supplierID": "supplierID_value",
                  "orderDate": "2024/01/01", "deliveryDate": "2024/01/01", "materialID": "materialID_value",
                  "quantity": 1, "netPrice": 1.1, "currency": "currency_value",
                  "purchasingGroup": "purchasingGroup_value", "purchasingOrganization": "purchasingOrganization_value",
                  "plant": "plant_value", "paymentTerms": "paymentTerms_value", "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
...
class TestDocumentFlow(unittest.TestCase):
    ...
    def test_display_success_finished(self):
        response = self.app.get(
            ...
            json={"PurchaseOrder": "purchaseOrderID_value", "GoodsReceipt": "goodsReceiptID_value",
                  "userID": "userID_value"},
            headers={"Authorization": "Bearer <token>",
                     "Content-Type": "application/json"}
        )
