...
class TestSupplier(unittest.TestCase):
    ...
    def test_create_success(self):
        ...
        self.assertEqual(
            response.json,
            {
                "code": 201,
                "message": "success",
                "data": {"supplierID": "supplierID_value"},
            },
        )
    ...
    def test_update_success(self):
        ...
        self.assertEqual(response.json, {"code": 200, "message": "success", "data": {}})
    ...
    def test_update_not_found(self):
        ...
        self.assertEqual(
            response.json, {"code": 204, "message": "supplier not found", "data": []}
        )
...
class TestMaterial(unittest.TestCase):
    ...
    def test_create_success(self):
        ...
        self.assertEqual(
            response.json,
            {
                "code": 201,
                "message": "success",
                "data": {"materialID": "materialID_value"},
            },
        )
    ...
    def test_update_not_found(self):
        ...
        self.assertEqual(response.status_code, 204)
        self.assertEqual(
            response.json, {"code": 204, "message": "material not found", "data": []}
        )
...
class TestStock(unittest.TestCase):
    ...
    def test_create_success(self):
        ...
        self.assertEqual(
            response.json,
            {"code": 201, "message": "success", "data": {"stockID": "stockID_value"}},
        )
    ...
    def test_update_not_found(self):
        ...
        self.assertEqual(response.status_code, 204)
        self.assertEqual(
            response.json, {"code": 204, "message": "stock not found", "data": []}
        )
...
class TestGoodsReceipt(unittest.TestCase):
    ...
    def test_create_success(self):
        ...
        self.assertEqual(
            response.json,
            {
                "code": 201,
                "message": "success",
                "data": {"goodsReceiptID": "goodsReceiptID_value"},
            },
        )
    ...
    def test_update_not_found(self):
        ...
        self.assertEqual(
            response.json,
            {"code": 204, "message": "goods receipt not found", "data": []},
        )
...
class TestPurchaseOrder(unittest.TestCase):
    ...
    def test_create_success(self):
        ...
        self.assertEqual(
            response.json,
            {
                "code": 201,
                "message": "success",
                "data": {"purchaseOrderID": "purchaseOrderID_value"},
            },
        )
    ...
    def test_update_not_found(self):
        ...
        self.assertEqual(
            response.json,
            {"code": 204, "message": "purchase order not found", "data": []},
        )
...
class TestUser(unittest.TestCase):
    ...
    def test_login_success(self):
        ...
        self.assertEqual(
            response.json,
            {
                "code": 1,
                "message": "success",
                "data": {"username": "username_value", "role": "role_value"},
            },
        )
    ...
    def test_login_not_found(self):
        ...
        self.assertEqual(
            response.json, {"code": 0, "message": "user not found", "data": {}}
        )
    ...
    def test_login_wrong_password(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            response.json, {"code": 0, "message": "wrong password", "data": {}}
        )
    ...
    def test_register_success(self):
        ...
        self.assertEqual(
            response.json,
            {"code": 1, "message": "success", "data": {"userID": "userID_value"}},
        )
    ...
    def test_change_password_success(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json, {"code": 1, "message": "success", "data": {}})
...
class TestDocumentFlow(unittest.TestCase):
    ...
    def test_display_success(self):
        ...
        response = self.app.get(
            ...
            json={
                "PurchaseOrder": "purchaseOrderID_value",
                "GoodsReceipt": "goodsReceiptID_value",
                "userID": "userID_value",
            },
            headers={
                "Authorization": "Bearer <token>",
    ...
    def test_display_not_found(self):
        ...
        self.assertEqual(response.status_code, 404)
        self.assertEqual(
            response.json, {"code": 0, "message": "document flow not found", "data": []}
        )
