...
def register_routes(app):
    from .apis import Controller, UserController, DocumentFlowController
    ...
    app.register_blueprint(DocumentFlowController.register_entity(entityName="DocumentFlow", env=env))
